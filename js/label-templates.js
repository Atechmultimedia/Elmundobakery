...
const LABEL_TEMPLATES = {
  ...
  prestige: {
    name: "Prestige",
    blurb: "Deep green seal with double gold rings, logo and bread centre stage. The premium one.",
    wantsArt: true,
    wantsLogo: true
  },
  ribbon: {
    name: "Ribbon",
    blurb: "Cream label, product name on a gold ribbon, logo above the bread. Warm and friendly.",
    wantsArt: true,
    wantsLogo: true
  }
};
...
function labelTemplateCss(c) {
  return `
    ...
    /* ---- Prestige: the premium seal ---- */
    .tpl-prestige { background: ${c.primary}; color: ${c.bg};
      border: 0.5mm solid ${c.accent};
      box-shadow: inset 0 0 0 0.9mm ${c.primary}, inset 0 0 0 1.15mm ${c.accent}; }
    .tpl-prestige .lb-name { color: ${c.accent}; text-transform: uppercase;
      letter-spacing: 0.06em; font-size: 1.15em; }
    .tpl-prestige .lb-name::after { content: ""; display: block; width: 34%; height: 0.3mm;
      background: ${c.accent}; margin: 0.6mm auto 0; opacity: 0.85; }
    .tpl-prestige .lb-weight, .tpl-prestige .lb-price { color: ${c.bg}; }
    .tpl-prestige .lb-ing, .tpl-prestige .lb-allergen, .tpl-prestige .lb-bb,
    .tpl-prestige .lb-batch { color: ${c.bg}; opacity: 0.92; }
    .tpl-prestige .lb-foot { color: ${c.accent}; border-top: 0.15mm solid ${c.accent};
      padding-top: 0.5mm; opacity: 0.95; }
    .tpl-prestige .lb-logo { background: ${c.bg}; border-radius: 50%; padding: 0.7mm;
      box-shadow: 0 0 0 0.25mm ${c.accent}; }
    .tpl-prestige .lb-art-img { box-shadow: 0 0 0 0.3mm ${c.accent}; }

    /* ---- Ribbon: name on a gold band ---- */
    .tpl-ribbon { background: ${c.bg}; border: 0.35mm solid ${c.primary};
      box-shadow: inset 0 0 0 0.8mm ${c.bg}, inset 0 0 0 1mm ${c.accent}; }
    .tpl-ribbon .lb-name { background: ${c.accent}; color: ${c.primary};
      display: inline-block; padding: 0.5mm 2.4mm; margin: 0.4mm 0;
      clip-path: polygon(0 0, 100% 0, calc(100% - 1.2mm) 50%, 100% 100%, 0 100%, 1.2mm 50%);
      font-size: 1.1em; }
    .tpl-ribbon .lb-weight { color: ${c.primary}; font-weight: bold; }
    .tpl-ribbon .lb-foot { color: ${c.primary}; opacity: 0.85;
      border-top: 0.15mm dotted ${c.primary}; padding-top: 0.4mm; }

    /* Photo art crops to a neat circle on every design */
    .lb-art-img { display: block; width: 100%; height: 100%;
